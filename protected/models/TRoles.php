 ...
 *
 * The followings are the available columns in table 't_roles':
 * @property integer $IDROL
 * @property string $NOMBREROL
 */
class TRoles extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('IDROL, NOMBREROL', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TRoles the static model class
	 */
